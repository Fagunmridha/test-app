      ...
      <Box flex={1} backgroundColor="background">
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20 }}>
          ...
          >
            ...
            <Text color="text" style={{ fontSize: 15, lineHeight: 22 }}>
              Manage your reading preferences, sync your data across devices,
              and view detailed reading statistics and progress.
            </Text>
          </Box>
          ...
          >
            ...
            <Text color="text" style={{ fontSize: 15, lineHeight: 22 }}>
              View your reading streaks, completed books, time spent reading,
              and other insights about your reading habits.
            </Text>
          </Box>
